package haxe.ds._ObjectMap {
	public class NativePropertyIterator {
		...
		static public function iterator(collection : *) : haxe.ds._ObjectMap.NativePropertyIterator {
			var result : haxe.ds._ObjectMap.NativePropertyIterator = new haxe.ds._ObjectMap.NativePropertyIterator();
